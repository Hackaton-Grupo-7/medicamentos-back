...
//    @BeforeEach
//    void setUp() {
//        allergyService = new AllergyService(allergyRepository, medicationRepository);
//    }
//
//    @Test
...
//
//        when(allergyRepository.save(Mockito.any(Allergy.class))).thenReturn(new Allergy(1L, dust.name(), new User()));
